    ...
    def forward(self, inputs):
        ...
        for i, face in enumerate(orders):
            ...
            for j, connect_side in enumerate(['up', 'down', 'left', 'right']):
                ...
                mask = self.data[key][face][connect_side]['mask'].to("mps").repeat(repeats, 1, 1, c).permute(0, 3, 1, 2)
                xy = self.data[key][face][connect_side]['xy'].to("mps").repeat(repeats, 1, 1, 1)
